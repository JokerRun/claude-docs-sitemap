...
<h2}>
  ...
  <h2}>
    Sumber daya untuk penyerapan AI
  </h2>
    ...
    <Card title="Ikhtisar Dokumen API Claude" icon="robot" href="/docs/for-claude">
      Ikhtisar ringkas dokumentasi API Claude, dioptimalkan untuk penyerapan LLM.
    </Card>
