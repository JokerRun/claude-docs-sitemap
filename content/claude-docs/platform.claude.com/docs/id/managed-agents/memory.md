...
sha256: 4c800767f3402cd144bf1306eaa91ac95323715785b7ca206adb07c7798ebcdb
---

# Menggunakan memori agen

Berikan agen Anda memori persisten yang bertahan di seluruh sesi menggunakan penyimpanan memori.
...
## Membuat memory store \{#create-a-memory-store}
...
### Mengisi dengan konten awal (opsional) \{#seed-it-with-content-optional}
...
## Melampirkan memory store ke sesi \{#attach-a-memory-store-to-a-session}
...
### Bagaimana agen mengakses memori \{#how-the-agent-accesses-memory}
...
## Melihat dan mengedit memori \{#view-and-edit-memories}
...
### Mendaftar memori \{#list-memories}
...
### Membuat memori \{#create-a-memory}
...
### Memperbarui memori \{#update-a-memory}
...
#### Pengeditan konten yang aman (optimistic concurrency) \{#safe-content-edits-optimistic-concurrency}
...
### Menghapus memori \{#delete-a-memory}
...
## Mengaudit perubahan memori \{#audit-memory-changes}
...
### Mengambil versi \{#retrieve-a-version}
...
### Meredaksi versi \{#redact-a-version}
...
## Mengelola memory store \{#manage-memory-stores}
...
### Mengarsipkan store \{#archive-a-store}
...
## Praktik terbaik untuk manajemen memori \{#best-practices-for-memory-management}
