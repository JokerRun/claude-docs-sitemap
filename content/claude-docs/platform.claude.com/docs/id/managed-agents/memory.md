...
<Tip>
  Memori individual di dalam store dibatasi hingga 100 kB (\~25 ribu token). Sebuah store menampung maksimum 10.000 memori. Susun memori sebagai banyak file kecil yang terfokus, bukan beberapa file besar.
</Tip>
