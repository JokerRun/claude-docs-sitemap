---
source: platform
url: https://platform.claude.com/docs/id/managed-agents/observability
fetched_at: 2026-04-10T03:11:42.436400Z
sha256: 138a645eef468b45c7958a94336546f2da9d7ea9a9b3de13a1115b1f436b15de
---

# Pelacakan sesi

Pantau dan debug sesi Anda menggunakan tampilan timeline Console dan tampilan acara mentah.
...
- **Daftar sesi** - Semua sesi dengan status, waktu pembuatan, dan model mereka
- **Tampilan pelacakan** - Tampilan kronologis acara (konten, stempel waktu, penggunaan token) dalam sesi. Ini hanya dapat diakses oleh Pengembang dan Admin.
...
- **Periksa acara sesi** - Kesalahan sesi disampaikan melalui acara `session.error`
...
- **Gunakan prompt sistem** - Tambahkan instruksi logging ke prompt sistem untuk membuat agen menjelaskan penalarannya