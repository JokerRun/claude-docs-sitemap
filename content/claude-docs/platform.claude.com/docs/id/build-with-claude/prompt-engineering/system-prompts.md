...
sha256: 84b41c04da8818f5803356e818536fcc62281974b7372a7f9c9a95b6cfccd01d
---
...
Saat menggunakan Claude, Anda dapat meningkatkan kinerjanya secara dramatis dengan menggunakan parameter `system` untuk memberikan peran kepadanya. Teknik ini, yang dikenal sebagai role prompting, adalah cara paling ampuh untuk menggunakan system prompts dengan Claude.

Peran yang tepat dapat mengubah Claude dari asisten umum menjadi ahli domain virtual Anda!

<Tip>**Tips system prompt**: Gunakan parameter `system` untuk menetapkan peran Claude. Letakkan semua hal lainnya, seperti instruksi khusus tugas, di giliran `user` sebagai gantinya.</Tip>

## Mengapa menggunakan role prompting?

- **Akurasi yang ditingkatkan:** Dalam skenario kompleks seperti analisis hukum atau pemodelan keuangan, role prompting dapat meningkatkan kinerja Claude secara signifikan.
- **Nada yang disesuaikan:** Baik Anda membutuhkan keringkasan CFO atau gaya copywriter, role prompting menyesuaikan gaya komunikasi Claude.
- **Fokus yang ditingkatkan:** Dengan menetapkan konteks peran, Claude tetap berada dalam batas persyaratan spesifik tugas Anda.

***

## Cara memberikan peran kepada Claude

Gunakan parameter `system` di [Messages API](/docs/id/api/messages) untuk menetapkan peran Claude:
...
| Assistant | Berikut adalah ringkasan poin-poin kunci dalam perjanjian lisensi perangkat lunak:<br/><br/>1. Indemnifikasi (Bagian 8):<br/>   - Kami mengindemnifikasi vendor terhadap klaim yang timbul dari penggunaan kami.<br/><br/>2. Pembatasan Tanggung Jawab (Bagian 9):<br/>   - Kerusakan dibatasi pada \$500.<br/><br/>3. Kepemilikan IP (Bagian 12):<br/>   - Kami mempertahankan kepemilikan modifikasi kami.<br/><br/>Secara keseluruhan, perjanjian ini tampak standar. Klausa indemnifikasi dan tanggung jawab adalah tipikal, dan kami mempertahankan hak IP kami. |

</section>

Dengan peran, Claude menangkap masalah kritis yang dapat menghabiskan jutaan:
...
| Assistant | Saya telah meninjau perjanjian lisensi perangkat lunak, dan saya memiliki kekhawatiran serius yang dapat mengekspos perusahaan kami terhadap risiko signifikan:<br/><br/>1. Indemnifikasi (Bagian 8):<br/>   - Masalah Kritis: Kami mengindemnifikasi vendor terhadap "semua dan setiap klaim" yang timbul dari penggunaan kami.<br/>   - Risiko: Ini dapat membuat kami bertanggung jawab bahkan atas kelalaian vendor atau cacat produk.<br/>   - Rekomendasi: Tolak. Batasi indemnitas kami pada klaim yang timbul dari pelanggaran kami terhadap perjanjian.<br/><br/>2. Pembatasan Tanggung Jawab (Bagian 9):<br/>   - Masalah Kritis: Kerusakan dibatasi pada \$500, termasuk kerusakan langsung.<br/>   - Risiko: Sangat tidak memadai. Kegagalan kritis dalam infrastruktur data kami dapat menghabiskan jutaan dalam kehilangan pendapatan dan kerusakan reputasi.<br/>   - Rekomendasi: Tolak. Negosiasikan untuk batas pada 12 bulan biaya untuk kerusakan langsung, dan pengecualian untuk pelanggaran data.<br/><br/>3. Kepemilikan IP (Bagian 12):<br/>   - Masalah Kritis: Vendor mendapatkan kepemilikan bersama atas modifikasi dan integrasi kami.<br/>   - Risiko: Mereka dapat menggunakan atau menjual algoritma proprietary atau wawasan data kami kepada pesaing.<br/>   - Rekomendasi: Tolak. Kami harus mempertahankan kepemilikan penuh atas pekerjaan kami.<br/><br/>Pendapat Profesional: Jangan menandatangani perjanjian ini. Ini sangat tidak menguntungkan dan mengekspos kami terhadap tingkat risiko yang tidak dapat diterima. Jika vendor menolak untuk merundingkan kembali syarat-syarat ini, saya sangat menyarankan untuk mengeksplorasi penyedia alternatif atau mempercepat solusi internal kami. Biaya potensial dari melanjutkan dengan perjanjian ini jauh melampaui keuntungan jangka pendek apa pun. |
...
| Peran | Konten |
| ---- | ------- |
| User | Anda adalah CFO dari perusahaan B2B SaaS dengan pertumbuhan tinggi. Kami sedang dalam rapat dewan membahas keuangan Q2 kami:<br/>\<data><br/>\{\{FINANCIALS\}\}<br/>\</data><br/><br/>Analisis tren kunci, tandai kekhawatiran, dan rekomendasikan tindakan strategis. Investor kami menginginkan pertumbuhan agresif tetapi waspada terhadap burn rate kami. |
| Assistant | Anggota dewan, berikut adalah analisis saya tentang keuangan Q2 kami:<br/><br/>1. Pendapatan (\$15.2M, +22% YoY):<br/>   - Wawasan: Pertumbuhan enterprise (+30%) melampaui pertumbuhan keseluruhan.<br/>   - Bendera: Segmen SMB menurun 5%.<br/>   - Tindakan: Alokasikan kembali 20% anggaran pemasaran SMB ke penjualan enterprise. Tugaskan produk untuk menyederhanakan onboarding SMB.<br/><br/>2. Margin (Gross: 72%, +3% QoQ; EBITDA: 18%, -2% QoQ):<br/>   - Wawasan: Optimisasi infrastruktur meningkatkan margin kotor.<br/>   - Bendera: Pengeluaran R&D pada fitur AI mengurangi EBITDA.<br/>   - Tindakan: Tidak ada perubahan. Roadmap AI kami sangat penting untuk keberhasilan enterprise.<br/><br/>3. Kas (\$4.1M OCF, \$28M cadangan):<br/>   - Wawasan: Runway 15 bulan pada burn saat ini.<br/>   - Bendera: CAC naik 20%, mengikis LTV/CAC.<br/>   - Tindakan: Bekukan perekrutan non-esensial. Implementasikan analitik corong penjualan untuk mengurangi CAC sebesar 15% di Q3.<br/><br/>Sikap Strategis: Kami sedang menyeimbangkan antara pertumbuhan dan burn. Fokus enterprise adalah mesin pertumbuhan kami—investasikan di sana. Tetapi perhatikan churn SMB; itu dapat mengalir ke enterprise. Taruhan AI kami masuk akal, tetapi kami harus mengubahnya menjadi ARR pada Q4, atau kami potong R&D sebesar 30%.<br/><br/>Singkatnya: Perkuat enterprise, sederhanakan SMB, optimalkan penjualan, dan monetisasi AI. Pertanyaan? |
