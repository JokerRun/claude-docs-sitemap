...
Fitur pada Claude Platform diberi salah satu klasifikasi ketersediaan berikut per platform (ditampilkan di kolom Ketersediaan pada setiap tabel berikut). Tidak semua fitur melewati setiap tahap. Sebuah fitur dapat masuk pada klasifikasi mana pun dan dapat melewati tahap-tahap tertentu.
...
## File dan aset \{#files-and-assets}
