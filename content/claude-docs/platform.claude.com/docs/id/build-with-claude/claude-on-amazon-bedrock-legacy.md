...
Memanggil Claude melalui Bedrock sedikit berbeda dari cara Anda memanggil Claude di Claude API secara langsung. Panduan ini memandu Anda menyelesaikan panggilan API ke Claude di Bedrock menggunakan salah satu [client SDK](/docs/id/cli-sdks-libraries/overview) Anthropic.
...
## Instal dan konfigurasi AWS CLI \{#install-and-configure-the-aws-cli}
...
## Instal SDK untuk mengakses Bedrock \{#install-an-sdk-for-accessing-bedrock}
...
## Mengakses Bedrock \{#accessing-bedrock}
...
| Claude Sonnet 4 <br /><small>Deprecated.</small> | anthropic.claude-sonnet-4-20250514-v1:0 | Ya | Ya | Ya | Tidak | Ya |
| Claude Sonnet 3.7 <br /><small>Retired.</small> | anthropic.claude-3-7-sonnet-20250219-v1:0 | Tidak | Tidak | Tidak | Tidak | Tidak |
| Claude Opus 4.5 | anthropic.claude-opus-4-5-20251101-v1:0 | Ya | Ya | Ya | Tidak | Tidak |
| Claude Opus 4.1 <br /><small>Deprecated.</small> | anthropic.claude-opus-4-1-20250805-v1:0 | Tidak | Ya | Tidak | Tidak | Tidak |
| Claude Opus 4 <br /><small>Retired.</small> | anthropic.claude-opus-4-20250514-v1:0 | Tidak | Tidak | Tidak | Tidak | Tidak |
| Claude Haiku 4.5 | anthropic.claude-haiku-4-5-20251001-v1:0 | Ya | Ya | Ya | Tidak | Tidak |
| Claude Haiku 3.5 <br /><small>Deprecated.</small> | anthropic.claude-3-5-haiku-20241022-v1:0 | Tidak | Ya | Tidak | Tidak | Tidak |
...
### Daftar model yang tersedia \{#list-available-models}
...
Lihat [client SDK](/docs/id/cli-sdks-libraries/overview) untuk detail lebih lanjut, dan [dokumentasi resmi Bedrock](https://docs.aws.amazon.com/bedrock/).
...
### Dukungan PDF di Bedrock \{#pdf-support-on-bedrock}
...
- Analisis PDF visual (grafik, gambar, tata letak) memerlukan citations diaktifkan
- Tanpa citations, hanya ekstraksi teks dasar yang tersedia
- Untuk kontrol penuh tanpa citations yang dipaksakan, gunakan InvokeModel API
...
## Endpoint global vs regional \{#global-vs-regional-endpoints}
