...
sha256: 8f05bf96aca86b93960a179a03cc89be8d9a2d2ac09cb34d896f79d6762db202
---

# FAQ Compliance API

Jawaban atas pertanyaan umum tentang akses Compliance API, scope, retensi, dan integrasi.
...
## Akses dan scope \{#access-and-scopes}
...
<section title="Mengapa kunci Admin API saya mengembalikan 403 pada endpoint chat atau file?">
...
<section title="Bagaimana cara mengorelasikan record Compliance API dengan SIEM saya?">
