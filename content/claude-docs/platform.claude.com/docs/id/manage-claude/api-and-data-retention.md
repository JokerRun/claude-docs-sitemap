...
#### Pembatasan skema dan definisi alat \{#schema-and-tool-definition-restrictions}
...
### CORS tidak didukung untuk ZDR \{#cors-not-supported-for-zdr}
...
<section title="Dapatkah saya menggunakan fitur yang memenuhi syarat ZDR (dengan kualifikasi) di bawah pengaturan ZDR saya?">
...
<section title="Bagaimana cara meminta akses API yang siap HIPAA?">
...
<section title="Apakah ini berlaku untuk Amazon Bedrock atau Vertex AI?">
...
<section title="Apakah Claude Platform di AWS memenuhi syarat untuk ZDR atau kesiapan HIPAA?">
