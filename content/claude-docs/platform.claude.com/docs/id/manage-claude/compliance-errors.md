...
sha256: f27e5df33090df8e81d0125a2c6782ad206c72a017dcd06b10341708c6aac068
---
...
### Scope tidak mencukupi: Activity Feed \{#insufficient-scope-activity-feed}
...
### Scope tidak mencukupi: data organisasi \{#insufficient-scope-organization-data}
...
### Scope tidak mencukupi: pengaturan organisasi \{#insufficient-scope-organization-settings}
...
### Scope tidak mencukupi: data pengguna \{#insufficient-scope-user-data}
...
### Scope tidak mencukupi: delete \{#insufficient-scope-delete}
...
### Pengaturan organisasi tidak tersedia \{#organization-settings-not-available}
...
### Proyek memiliki chat terlampir \{#project-has-attached-chats}
