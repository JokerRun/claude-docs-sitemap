...
* Berikan `last_id` dari respons sebagai `after_id` untuk maju ke halaman berikutnya dalam urutan hasil. Karena aktivitas diurutkan dari yang terbaru terlebih dahulu, halaman berikutnya berisi entri yang lebih lama.
...
| `anthropic_actor`            | Anthropic bertindak pada organisasi, misalnya melalui perangkat internal.                                                                                                                                              | `email_address` (selalu `null`; ada demi konsistensi bentuk dengan `user_actor`, karena operator Anthropic tidak direpresentasikan dengan email individual) |
