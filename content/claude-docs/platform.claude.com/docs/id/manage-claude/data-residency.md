...
Parameter `inference_geo` didukung pada [Batch API](https://platform.claude.com/docs/id/build-with-claude/batch-processing). Setiap permintaan dalam batch dapat menentukan nilai `inference_geo` sendiri.
