...
sha256: 1219f8142efcf693f9ac78b643d89fe2f20137eb4e365fea74e8790f83736983
---
...
| **Claude Enterprise** (`claude.ai`)                         | [claude.ai > Organization settings > API](https://claude.ai/admin-settings/api-access)    | `sk-ant-api01-...`   | **Primary owner** organisasi induk (semua organisasi tertaut). Seorang **organization owner** dapat membuat kunci yang hanya membawa scope Compliance API, terbatas pada organisasinya sendiri | [Manajemen pengguna](https://platform.claude.com/docs/id/manage-claude/user-management) (endpoint member, invite, dan group milik Admin API), [Compliance API](https://platform.claude.com/docs/id/manage-claude/compliance-api), [Claude Enterprise Analytics API](https://platform.claude.com/docs/id/manage-claude/analytics-api), dan [Spend Limits API](https://platform.claude.com/docs/id/manage-claude/spend-limits-api), sesuai dengan [scope](https://platform.claude.com/docs/id/manage-claude/admin-api-keys#choose-scopes-for-a-claude-enterprise-key) yang Anda pilih |
...
<Steps>
  ...
  <Step title="Salin dan simpan secret">
    Salin secret yang ditampilkan (diawali dengan `sk-ant-admin01-`) dan simpan di secrets manager Anda. Secret lengkap hanya ditampilkan satu kali.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Salin dan simpan secret">
    Salin secret yang ditampilkan (diawali dengan `sk-ant-api01-`) dan simpan di secrets manager Anda. Secret lengkap hanya ditampilkan satu kali.
  </Step>
</Steps>
...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- |
| [Manajemen pengguna](https://platform.claude.com/docs/id/manage-claude/user-management) Admin API: mendaftar dan mencari member serta invite; membaca peran kustom dan izinnya                                                                                                                                                                                                                                                            | `read:members`                |
| [Manajemen pengguna](https://platform.claude.com/docs/id/manage-claude/user-management) Admin API: mengubah peran member, menghapus member, membuat dan menarik invite                                                                                                                                                                                                                                                                    | `write:members`               |
| [Manajemen pengguna](https://platform.claude.com/docs/id/manage-claude/user-management) Admin API: membaca group dan anggotanya                                                                                                                                                                                                                                                                                                           | `read:rbac_groups`            |
| [Manajemen pengguna](https://platform.claude.com/docs/id/manage-claude/user-management) Admin API: membuat, mengganti nama, dan menghapus group; menambah dan menghapus anggota group; menetapkan group saat pembuatan invite                                                                                                                                                                                                             | `write:rbac_groups`           |
| [Spend Limits API](https://platform.claude.com/docs/id/manage-claude/spend-limits-api): membaca batas pengeluaran efektif member dan permintaan kenaikan                                                                                                                                                                                                                                                                                  | `read:spend_limits`           |
...
| [Endpoint chat, file, dan project Compliance API](https://platform.claude.com/docs/id/manage-claude/compliance-content-data) dan [endpoint session Compliance API](https://platform.claude.com/docs/id/manage-claude/compliance-sessions): membaca chat, file, project, transkrip sesi Cowork dan Claude Code, serta [pengguna organisasi](https://platform.claude.com/docs/id/manage-claude/compliance-org-data#list-organization-users) | `read:compliance_user_data`   |
| [Endpoint chat, file, dan project Compliance API](https://platform.claude.com/docs/id/manage-claude/compliance-content-data): menghapus chat, file, dan project                                                                                                                                                                                                                                                                           | `delete:compliance_user_data` |
