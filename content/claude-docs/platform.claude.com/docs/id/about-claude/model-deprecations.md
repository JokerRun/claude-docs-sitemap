...
sha256: 8cb6d728bf160c5280a421f08691eb76f94717335b295c73e0a7abd3c808e159
---

# Penghentian model

Informasi tentang penghentian model Anthropic, termasuk status model, tanggal pensiun, dan panduan migrasi ke model pengganti.

---

Seiring kami meluncurkan model yang lebih aman dan lebih mampu, kami secara teratur menghentikan model yang lebih lama. Aplikasi yang mengandalkan model Anthropic mungkin memerlukan pembaruan sesekali untuk terus berfungsi. Pelanggan yang terdampak akan selalu diberitahu melalui email dan dalam dokumentasi kami.
...
Audit ini akan membantu Anda menemukan instans apa pun di mana aplikasi Anda masih menggunakan model yang dihentikan, memungkinkan Anda memprioritaskan pembaruan ke model yang lebih baru sebelum tanggal pensiun.

## Praktik terbaik

1. Periksa dokumentasi kami secara teratur untuk pembaruan tentang penghentian model.
...
| Tanggal Pensiun             | Model yang Dihentikan       | Pengganti yang Direkomendasikan |
|:----------------------------|:----------------------------|:--------------------------------|
| 19 Februari 2026           | `claude-3-7-sonnet-20250219`| `claude-opus-4-6`                 |
...
| Tanggal Pensiun             | Model yang Dihentikan       | Pengganti yang Direkomendasikan |
|:----------------------------|:----------------------------|:--------------------------------|
| 28 Oktober 2025            | `claude-3-5-sonnet-20240620`| `claude-opus-4-6`                 |
| 28 Oktober 2025            | `claude-3-5-sonnet-20241022`| `claude-opus-4-6`                 |
...
| Tanggal Pensiun             | Model yang Dihentikan       | Pengganti yang Direkomendasikan |
|:----------------------------|:----------------------------|:--------------------------------|
| 5 Januari 2026             | `claude-3-opus-20240229`    | `claude-opus-4-6`      |
...
| Tanggal Pensiun             | Model yang Dihentikan       | Pengganti yang Direkomendasikan |
|:----------------------------|:----------------------------|:--------------------------------|
| 21 Juli 2025               | `claude-2.0`                | `claude-opus-4-6`                  |
| 21 Juli 2025               | `claude-2.1`                | `claude-opus-4-6`                  |
| 21 Juli 2025               | `claude-3-sonnet-20240229`  | `claude-opus-4-6`                  |
