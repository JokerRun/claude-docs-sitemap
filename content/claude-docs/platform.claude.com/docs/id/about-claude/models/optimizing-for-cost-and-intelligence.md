...
sha256: 5a07658e3538802b50acf671216130a137bf641fe14638365d41425d77d10381
---
...
| Seseorang menunggu di antara giliran                         | Gunakan durasi cache 1 jam jika sekitar 1 dari 20 giliran terjadi setelah jeda antara 5 menit dan satu jam, dan hanya sedikit jeda yang melebihi satu jam. Pada Claude Fable 5.1, jaga cache 5 menit tetap hangat selama jeda hanya berlangsung beberapa menit, dan beli durasi 1 jam ketika jeda mendekati satu jam | [Pilih durasi cache](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#pick-the-cache-duration)                                                                                                                                                  |
...
| Anda belum menggunakan model terbaru                         | Lakukan upgrade; model saat ini menyelesaikan lebih banyak tugas, dengan biaya per tugas yang diselesaikan berkisar dari sekitar 40% lebih rendah hingga sekitar 20% lebih tinggi                                                                                                                                    | [Upgrade model](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#upgrade-the-model)                                                                                                                                                             |
| Anda sedang memilih atau beralih model                       | Bandingkan berdasarkan biaya per tugas yang selesai, bukan per token                                                                                                                                                                                                                                                 | [Bandingkan model](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#compare-models-on-cost-per-task)                                                                                                                                            |
| Kualitas belum cukup baik                                    | Jika Anda menurunkan effort, kembalikan ke semula; jika tidak, coba tingkat model berikutnya di atasnya dengan effort `low`                                                                                                                                                                                          | [Setel effort](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#tune-effort) · [Bandingkan model](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#compare-models-on-cost-per-task)                 |
| Percobaan berakhir dengan `stop_reason: max_tokens`          | Naikkan `max_tokens`; nilai 64.000 mencakup semua kecuali 2 dari 14.000 giliran yang diukur pada effort default, dan nilai 128.000 tidak menambah biaya per tugas yang diselesaikan                                                                                                                                  | [Tetapkan anggaran](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#set-budgets-and-output-caps)                                                                                                                                               |
| Anda dapat memeriksa output (tes, verifier)                  | Jalankan semuanya pada effort rendah, lalu jalankan ulang yang gagal pada `high`; pada benchmark coding yang diukur, tingkat kelulusan tetap terjaga dengan sekitar setengah biaya                                                                                                                                   | [Jalankan ulang kegagalan](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#re-run-failures-at-higher-effort)                                                                                                                                   |
| Loop agen dengan beberapa run yang sangat mahal              | Tetapkan anggaran tugas (beta; periksa tabel dukungan untuk model yang didukung), anggaran sesi Claude Managed Agents, dan batas pengeluaran workspace                                                                                                                                                               | [Tetapkan anggaran](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#set-budgets-and-output-caps)                                                                                                                                               |
| Model berbiaya lebih rendah hanya macet pada keputusan sulit | Tambahkan advisor frontier. Strategi ini menguntungkan jika harga advisor jauh di atas executor dan advisor benar-benar dikonsultasikan. Jadi, hitung dulu biaya model advisor saja pada effort rendah dan ukur tingkat konsultasinya                                                                                | [Strategi advisor](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#advisor-strategy-escalate-hard-decisions)                                                                                                                                   |
| Pekerjaan melebihi satu jendela konteks                      | Delegasikan partisi pekerjaan ke worker yang lebih murah                                                                                                                                                                                                                                                             | [Strategi orchestrator](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#orchestrator-strategy-delegate-bulk-work)                                                                                                                              |

Hasil-hasil ini berasal dari pengukuran internal Anthropic ([Benchmark yang dirujuk](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#refs)) dan bersifat indikatif, bukan jaminan. Karena itu, lakukan pengukuran pada beban kerja Anda sendiri dengan [metode empat langkah](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#measure-on-your-own-workload).
...
Jika loop Anda menunggu seseorang di antara giliran, gunakan [durasi cache 1 jam](https://platform.claude.com/docs/id/build-with-claude/prompt-caching#1-hour-cache-duration). Biaya penulisannya lebih tinggi (2x harga input, bukan 1,25x). Namun, cache miss pada durasi mana pun menagih seluruh prefiks dengan harga tulis, bukan harga baca. Karena itu, durasi yang lebih panjang menguntungkan begitu beberapa giliran per sesi terjadi setelah jeda antara 5 menit dan satu jam.

Untuk memutuskan, hitung jeda antara permintaan-permintaan berurutan dalam sebuah percakapan:

* Jika lebih dari sekitar 1 dari 20 jeda berada antara 5 menit dan satu jam, dan jeda lebih dari satu jam jarang terjadi, gunakan durasi 1 jam.
* Jika giliran datang dengan selang beberapa detik, tetap gunakan default 5 menit. Ketika tidak ada jeda, default ini 15% lebih murah daripada pengaturan 1 jam pada Claude Sonnet 5 dan 11% lebih murah pada Claude Opus 5.
* Jika jeda lebih dari satu jam sering terjadi, tetap gunakan default. Jeda lebih dari satu jam membuat kedua durasi kedaluwarsa, lalu pengaturan 1 jam menulis ulang prefiks dengan harga tulisnya yang lebih tinggi, sehingga pengaturan ini rugi pada setiap jeda seperti itu. Jika sekitar 60% atau lebih dari jeda Anda yang melebihi 5 menit juga melewati satu jam, tetap gunakan default. Durasi 1 jam hanya menguntungkan jika setidaknya sekitar 40% jeda panjang berakhir dalam satu jam.

Anthropic mengukur pekerjaan triase dari [Pangkas token input dan konteks](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#trim-input-and-context-tokens) dengan menyisipkan jeda sebelum beberapa giliran untuk menyimulasikan keterlambatan seseorang[16](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#refs). Pada kedua model yang diukur, cache 1 jam menjadi pengaturan yang lebih murah begitu sekitar 1 dari 30 giliran terjadi setelah jeda. Jadi, aturan 1-dari-20 menyisakan margin. Selisihnya juga melebar dengan cepat setelah titik persilangan, karena setiap giliran setelah jeda pada pengaturan 5 menit menulis ulang seluruh prefiks. Semua model saat ini menggunakan pengali cache-write yang sama. Semua model kecuali Claude Fable 5.1, Claude Mythos 5.1, dan Claude Opus 5.5 juga menggunakan harga baca yang sama, sehingga titik persilangannya berada dalam rentang yang sama pada model-model lain. Fable 5.1 adalah kasus yang dibahas berikutnya. Akurasi tetap berada dalam batas noise antar-run di setiap sel. Giliran setelah jeda mempertahankan latensi cache hangatnya pada pengaturan 1 jam (diukur pada Claude Sonnet 5 dan Claude Opus 5, bukan pada Claude Opus 5.5). Grafik berikut memplot biaya per sesi terhadap porsi giliran setelah jeda pada Claude Sonnet 5:

![Grafik garis: biaya per sesi triase menurut porsi giliran setelah jeda; "1-hour cache" (cache 1 jam) lebih murah setelah sekitar 1 dari 30 giliran](https://platform.claude.com/docs/images/cost-intel-cache-ttl.png)

Anthropic juga mengukur permintaan tambahan yang menjaga cache 5 menit tetap hangat. Pada Claude Sonnet 5 dan Claude Opus 5, permintaan ini tidak menghasilkan penghematan yang terukur dibandingkan durasi 1 jam pada porsi giliran berjeda berapa pun. Permintaan ini bahkan lebih mahal jika ada jeda sebelum setiap giliran. Jadi, gunakan durasi 1 jam saja.

Pada Claude Fable 5.1, pengaturan termurahnya berbeda. [Cache read](https://platform.claude.com/docs/id/about-claude/pricing#prompt-caching) pada model ini berharga 0,025x harga input ($0,25 per juta token), sedangkan cache write-nya tetap menggunakan pengali standar. Akibatnya, permintaan keep-alive yang membaca ulang prefiks menjadi murah, dan premi tulis durasi 1 jam menjadi tagihan yang lebih besar. Anthropic mengukur pekerjaan triase pada Claude Fable 5.1 dengan tiga pengaturan yang sama[19](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#refs). Menjaga cache 5 menit tetap hangat 13% hingga 20% lebih murah per sesi daripada cache 1 jam selama jeda hanya berlangsung beberapa menit. Cache 1 jam baru unggul ketika jeda mendekati 45 menit, dengan selisih sekitar 12 sen per sesi. Pada Claude Fable 5.1, jaga cache 5 menit tetap hangat selama seseorang pergi hanya beberapa menit, dan beli durasi 1 jam ketika jeda mendekati satu jam:

![Grafik garis: biaya terukur per sesi triase menurut porsi giliran berjeda pada Claude Fable 5.1 dan Claude Sonnet 5; pada Fable 5.1 "keep-alive" (menjaga tetap hangat) tetap di bawah "1-hour cache" (cache 1 jam), pada Sonnet 5 cache 1 jam unggul begitu jeda sering terjadi](https://platform.claude.com/docs/images/cost-intel-cache-keepalive.png)

Untuk menjaga cache tetap hangat, kirim ulang permintaan sebelumnya dengan `max_tokens` diatur ke 0 dalam 4 menit sejak permintaan sebelumnya dimulai, lalu ulangi setiap 4 menit setelahnya. Hapus `stream` jika sebelumnya diatur. Hitung waktunya dari awal permintaan, bukan dari akhir responsnya. [Masa hidup 5 menit cache](https://platform.claude.com/docs/id/build-with-claude/prompt-caching#how-prompt-caching-works) dihitung sejak awal permintaan yang menulis atau menyegarkan entri, sehingga waktu yang dihabiskan respons untuk menghasilkan output ikut terhitung. Inilah yang disebut [permintaan pre-warming](https://platform.claude.com/docs/id/build-with-claude/prompt-caching#pre-warming-the-cache). Permintaan ini menyegarkan masa hidup cache, tidak menghasilkan apa pun, dan hanya ditagih untuk cache read. Jangan ubah satu byte pun dari prefiks, dan jangan gunakan `max_tokens: 1`, yang mengambil sampel satu token tanpa alasan. Kirim ulang header permintaan beserta body-nya. Jika permintaan Anda membawa header `anthropic-beta` (misalnya untuk [anggaran tugas](https://platform.claude.com/docs/id/build-with-claude/task-budgets)), permintaan keep-alive memerlukan header yang sama. Jika tidak, field yang dibatasi beta dalam body yang dikirim ulang akan ditolak. Permintaan `max_tokens: 0` ditolak jika permintaan tersebut mengatur `thinking.type: "enabled"` (adaptive thinking default pada Claude Fable 5.1 tidak masalah), structured outputs, atau pilihan alat yang dipaksakan ([batasannya](https://platform.claude.com/docs/id/build-with-claude/prompt-caching#limitations)). Pada beban kerja seperti itu, beli durasi 1 jam saja.

<CodeGroup exclude="shell:CLI, python, typescript, csharp, go, java, php, ruby">
  ```bash cURL
  # Dalam 4 menit sejak awal request terakhir (waktu pembuatan respons dihitung
  # terhadap masa hidup cache), kirim ulang request tersebut dengan max_tokens diatur ke
  # 0, tanpa stream (request max_tokens: 0 tidak dapat melakukan streaming). Kirim
  # header yang sama dengan request asli, termasuk header anthropic-beta jika ada.
...
Tuas-tuas ini menentukan posisi satu model di antara biaya dan kecerdasan. Yang termasuk di sini adalah pilihan model, effort, menjalankan ulang kegagalan pada pengaturan yang lebih tinggi, serta anggaran dan batas yang membatasi kerja model. Mulailah dengan menguji beberapa tingkat effort pada model Anda saat ini ([Setel effort](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#tune-effort)). Dari biaya dan kemampuan terendah hingga tertinggi, model-model saat ini adalah Claude Haiku 4.5, Claude Sonnet 5, Claude Opus 5.5, dan Claude Fable 5.1 (model frontier). [Ikhtisar model](https://platform.claude.com/docs/id/models/overview) memuat jajaran lengkap beserta harganya.
...
"Effort" (upaya) adalah cara paling langsung untuk menyetel model sesuai tugas Anda. Parameter `effort` mengatur seberapa banyak pemikiran, pemanggilan alat, dan verifikasi mandiri yang dilakukan model, dan `high`, default pada sebagian besar model, cocok untuk tugas yang menuntut; Claude Opus 5.5 secara default menggunakan `medium`. Biaya meningkat seiring semua aktivitas tersebut, sedangkan akurasi hanya meningkat seiring bagian yang benar-benar dibutuhkan tugas Anda. Di bawah batas atas kemampuan model, tingkat effort tertinggi membayar kedalaman yang tidak pernah digunakan oleh tugas.

Pada benchmark riset dan pekerjaan pengetahuan (WideSearch[1](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#refs), DeepWideSearch[6](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#refs), BrowseComp[4](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#refs), dan GDPval[2](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#refs), semuanya dengan Claude Fable 5), kurva akurasi terhadap biaya hampir datar. `low` mengorbankan 1 hingga 3 poin untuk menghemat sepertiga hingga setengah biaya per tugas. `medium` menyamai akurasi default dengan sekitar 70% hingga 87% biayanya. Default tidak memberikan keuntungan terukur apa pun dibandingkan `medium` pada keempat benchmark tersebut. Pada DeepWideSearch, `low` juga menyamai "orchestrator" (orkestrator) dengan "worker" (pekerja) Claude Sonnet 5 dengan biaya 29% lebih rendah. Artinya, menurunkan effort mengalahkan perubahan arsitektur.

Pengaturan effort yang lebih rendah sering kali lebih cepat, dan ini penting ketika "latency" (latensi) menjadi kendala. Dalam pengujian ini, `low` membutuhkan 4,5 menit per soal pada DeepWideSearch, dibandingkan 7,9 menit pada default. Pada [benchmark korpus](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#orchestrator-strategy-delegate-bulk-work), yang inputnya tidak muat dalam satu "context window" (jendela konteks) mana pun, Fable 5.1 membutuhkan 15,2 jam, 17,5 jam, dan 19,9 jam per episode masing-masing pada `low`, `medium`, dan `high`.

Coding jangka panjang adalah area di mana effort benar-benar meningkatkan akurasi. Pada SWE-bench Pro[3](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#refs), Claude Opus 5 kehilangan sekitar 2 poin pada `medium` dengan setengah biaya, dan sekitar 8 poin pada `low` dengan seperempat biaya. Ini adalah tradeoff yang nyata, tetapi [menjalankan ulang kegagalan pada effort lebih tinggi](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#re-run-failures-at-higher-effort) dapat mengubahnya kembali menjadi penghematan. Grafik ini memplot akurasi terhadap biaya untuk benchmark riset dan pekerjaan pengetahuan serta untuk SWE-bench Pro:

![Grafik garis akurasi terhadap biaya berdasarkan effort (upaya) pada lima benchmark: hampir datar pada empat tugas riset, curam pada SWE-bench Pro](https://platform.claude.com/docs/images/cost-intel-effort-sweep.png)

Ada dua konsekuensi dari hal ini. Pertama, gambarlah kurva ini untuk beban kerja Anda sendiri sebelum menambahkan model kedua. Dalam pengukuran internal ini, konfigurasi multi-model yang tampak lebih murah daripada model tunggal default ternyata lebih mahal daripada model yang sama pada effort lebih rendah. Kedua, kurva ini adalah baseline model tunggal yang harus dikalahkan oleh strategi multi-model mana pun. Karena itu, [langkah 2 pengukuran pada beban kerja Anda sendiri](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#measure-on-your-own-workload) menetapkan baseline di berbagai tingkat effort.

Pekerjaan yang sulit tidak otomatis membutuhkan effort tinggi. Pada DeepResearch Bench II[7](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#refs), Claude Fable 5.1 mendapat skor hampir sama pada `low`, `medium`, dan `high`, sementara biaya per tugas naik dari $4,66 menjadi $7,12. Jadi, dalam kasus ini menaikkan effort tidak meningkatkan kualitas output secara nyata. Pada 21 tugas yang bersih di setiap kelompok (referensi 7), Claude Fable 5 juga datar di seluruh tingkat effort. Namun, basis 33 tugas pada grafik, yang mengecualikan percobaan masing-masing model yang terpotong, menunjukkan skornya naik. Ukur kurva pada model yang Anda rilis, bukan pada model yang terakhir Anda ukur:

![Grafik garis skor rubrik terhadap biaya per tugas pada DeepResearch Bench II: pada Claude Fable 5.1, effort (upaya) yang lebih tinggi tidak menambah skor, hanya biaya](https://platform.claude.com/docs/images/cost-intel-effort-limit.png)

Deskripsi tugas saja tidak mengungkapkan jenis beban kerja yang Anda miliki. Karena itu, uji dua atau tiga tingkat effort pada sampel lalu lintas Anda sendiri dan baca jawabannya dari kurva. Uji setiap tingkat dalam sesi terpisah, karena mengubah effort tingkat atas di tengah sesi membatalkan cache (lihat [Cache konteks berulang](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#cache-repeated-context)) dan mendistorsi perbandingan. Untuk detail parameter, lihat [Effort](https://platform.claude.com/docs/id/build-with-claude/effort).
...
Angka-angka di halaman ini mencerminkan harga daftar pada saat pengukuran dan akan bergeser seiring perubahan model dan harga. Tingkat eskalasi Anda, seberapa rapi tugas dapat dibagi, dan panjang transkrip juga memengaruhi angka-angka tersebut. Namun, metodenya tetap sama:

1. Ambil beberapa tugas dari log produksi, dengan bobot yang mencerminkan lalu lintas nyata, dan [tulis pemeriksaan hasil](https://platform.claude.com/docs/id/test-and-evaluate/develop-tests) untuk masing-masing tugas. Contohnya: tes lulus, tiket ditutup, atau jumlah baris benar. Catat biaya per tugas di samping skornya. Untuk menghitung biaya, hitung harga kelima jumlah token berbayar dalam `usage` setiap respons dengan tarifnya masing-masing, lalu jumlahkan di seluruh permintaan dalam tugas tersebut. Kelima jumlah token tersebut adalah:

   * input tanpa cache
   * penulisan cache 5 menit, pada 1,25x harga input
   * penulisan cache 1 jam, pada 2x harga input
   * pembacaan cache
   * output

   [Usage and Cost API](https://platform.claude.com/docs/id/manage-claude/usage-cost-api) melaporkan nilai agregatnya.

2. Tetapkan baseline untuk setiap tingkatan model di berbagai tingkat effort, bukan hanya default, lalu plot skor terhadap pengeluaran. Konfigurasi multi-model harus mengalahkan seluruh kurva model tunggal.

3. Jika kurva menunjukkan kesenjangan yang tidak dapat ditutup oleh effort, tambahkan strategi multi-model yang sesuai dan jalankan ulang rangkaian pengujian.

4. Jalankan konfigurasi pemenang dalam mode shadow pada sebagian lalu lintas sebelum peralihan, lalu biarkan rangkaian pengujian tetap berjalan.
...
<CodeGroup>
  ...
  # Harga per juta token dari halaman harga; ubah ketiga nilai ini untuk model lain.
  INPUT_PER_MTOK = 5.00  # Claude Opus 5
  # 0,1x harga input pada Claude Opus 5; beberapa model memakai pengali berbeda
  ...
  cost = (
      ...
      # Penulisan cache 1 jam ditagih 2x harga input, 5 menit 1,25x; pembacaan pada harga baca cache.
...
Dalam loop agen, komponen cache-read biasanya merupakan yang terbesar dari kelima komponen. Jika tidak, periksa apakah caching sudah aktif. Ketika [alat advisor](https://platform.claude.com/docs/id/agents-and-tools/tool-use/advisor-tool#usage-and-billing) atau [compaction](https://platform.claude.com/docs/id/build-with-claude/compaction-threshold#understanding-usage) diaktifkan, sebagian token hanya dilaporkan dalam `usage.iterations`, bukan dalam total tingkat atas. Dalam kasus ini, jumlahkan dari `usage.iterations`, dan hitung harga entri `advisor_message` menggunakan tarif model advisor.
...
| -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Caching prompt                               | Biaya berkurang dengan faktor 2,7 hingga 5,3 pada loop agen; 83% pada run triase                                                                                                                                                                                                                                                                                                                                                                              | Tidak ada                                                                       | Lebih cepat                              | [Cache konteks berulang](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#cache-repeated-context)                                         |
| Durasi cache 1 jam                           | Lebih murah daripada default 5 menit jika sekitar 1 dari 20 giliran terjadi setelah jeda antara 5 menit dan satu jam, dan hanya sedikit jeda yang melebihi satu jam. Pengecualian: pada Claude Fable 5.1, menjaga cache 5 menit tetap hangat lebih murah selama jeda hanya beberapa menit, dan durasi 1 jam unggul ketika jeda mendekati satu jam. Tanpa jeda, default berbiaya 15% lebih rendah pada Claude Sonnet 5 dan 11% lebih rendah pada Claude Opus 5 | Tidak ada                                                                       | Tetap hangat setelah jeda                | [Pilih durasi cache](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#pick-the-cache-duration)                                            |
...
| File data melalui eksekusi kode              | 92% pada tugas data dengan 25 pertanyaan                                                                                                                                                                                                                                                                                                                                                                                                                      | Peningkatan: 25 dari 25 alih-alih 6 dari 25                                     | Lebih cepat                              | [Pangkas token input dan konteks](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#trim-input-and-context-tokens)                         |
...
| Upgrade model                                | Opus 4.8 ke Opus 5: 12 poin lebih tinggi dengan biaya 21% lebih besar per tugas terselesaikan (Opus 5 pada `low` mengalahkan Opus 4.8 dengan sekitar 30% biayanya). Sonnet 4.6 ke Sonnet 5: 15% lebih murah per tugas terselesaikan dan 5 poin lebih tinggi. Fable 5 ke Fable 5.1: 43% lebih murah per tugas terselesaikan dengan skor kurang lebih sama                                                                                                      | Peningkatan                                                                     | Netral                                   | [Upgrade model](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#upgrade-the-model)                                                       |
| Turunkan effort                              | Pekerjaan pengetahuan: `medium` 13% hingga 31%, `low` sepertiga hingga setengah. Coding panjang: `medium` sekitar setengah, `low` sekitar tiga perempat                                                                                                                                                                                                                                                                                                       | 1 hingga 3 poin pada pekerjaan pengetahuan; 2 hingga 8 poin pada coding panjang | Lebih cepat                              | [Menyetel effort](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#tune-effort)                                                           |
| Jalankan ulang kegagalan                     | Sekitar setengah, dengan tingkat kelulusan yang sama                                                                                                                                                                                                                                                                                                                                                                                                          | Tidak ada                                                                       | Dua run pada tugas yang gagal            | [Menjalankan ulang kegagalan pada effort lebih tinggi](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#re-run-failures-at-higher-effort) |
...
| Minta jawaban lebih singkat                  | 39% token output dan 14% biaya pada run triase                                                                                                                                                                                                                                                                                                                                                                                                                | Tidak ada                                                                       | Lebih cepat                              | [Menetapkan anggaran dan batas output](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#set-budgets-and-output-caps)                      |
| Menaikkan `max_tokens`                       | Tidak ada per tugas terselesaikan, tetapi lebih banyak tugas yang terselesaikan                                                                                                                                                                                                                                                                                                                                                                               | Peningkatan hingga 22 poin pada set internal; tidak ada pada pasangan publik    | Netral                                   | [Menetapkan anggaran dan batas output](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#set-budgets-and-output-caps)                      |
| Advisor                                      | Bergantung pada kesenjangan kemampuan dan tingkat konsultasi. Pasangan coding mendapat skor 3,5 poin di atas Opus 5 saja dan sekitar 2,5 poin di atas Fable 5.1 saja. Pasangan pembacaan grafik menyamai model advisor saja pada `medium` dengan sekitar 2,6 kali harganya                                                                                                                                                                                    | Peningkatan kecil                                                               | Sekitar dua panggilan tambahan per tugas | [Strategi advisor](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#advisor-strategy-escalate-hard-decisions)                             |
| Orchestrator                                 | Sekitar setengah dibandingkan model frontier, baik untuk pekerjaan yang melebihi satu jendela konteks maupun pada ekor biaya rutin (yang terakhir diukur pada Claude Fable 5)                                                                                                                                                                                                                                                                                 | 10 hingga 12 poin di bawah model frontier                                       | Jauh lebih cepat pada input besar        | [Strategi orchestrator](https://platform.claude.com/docs/id/about-claude/models/optimizing-for-cost-and-intelligence#orchestrator-strategy-delegate-bulk-work)                        |
