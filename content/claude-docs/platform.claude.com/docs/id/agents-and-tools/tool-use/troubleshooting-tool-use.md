...
sha256: ea91353a1152a50e2cc53322483d5c8f33e014203988ae076da216da571199fc
---
...
| Gejala                                              | Kemungkinan penyebab                                                                          | Perbaikan                                                                                                                                                                                                                                                                                                                                                                                                                     |
| --------------------------------------------------- | --------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Setiap permintaan adalah cache miss                 | `tool_choice`, konfigurasi pemikiran, atau `output_config.effort` bervariasi antar permintaan | Jaga `tool_choice` tetap stabil atau tempatkan breakpoint `cache_control` sebelum titik variasi; pertahankan konfigurasi pemikiran dan tingkat effort tetap konstan selama masa percakapan yang di-cache. Lihat [Penggunaan alat dengan caching prompt](/docs/id/agents-and-tools/tool-use/tool-use-with-prompt-caching) dan [Pemikiran dan caching prompt](/docs/id/build-with-claude/thinking#thinking-and-prompt-caching). |
