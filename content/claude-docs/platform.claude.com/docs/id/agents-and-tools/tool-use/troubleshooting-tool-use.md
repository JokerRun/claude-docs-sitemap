...
| `disable_parallel_tool_use` tampaknya diabaikan                        | Diatur terlalu lambat dalam percakapan | Harus diatur pada permintaan yang mengembalikan `tool_use`. Mengaturnya pada permintaan berikutnya tidak berpengaruh pada pemanggilan alat sebelumnya.                                                 |
