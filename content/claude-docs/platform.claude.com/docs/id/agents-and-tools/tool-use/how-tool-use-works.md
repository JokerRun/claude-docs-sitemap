...
sha256: d5f46dbd2239c4e8a9d7a7a4157e11c21fdf4300917613359563d8ded254456f
---
...
## Kontrak penggunaan alat \{#the-tool-use-contract}
...
## Di mana alat dijalankan \{#where-tools-run}
...
### Alat yang didefinisikan pengguna (dieksekusi di klien) \{#user-defined-tools-client-executed}
...
### Alat skema Anthropic (dieksekusi di klien) \{#anthropic-schema-tools-client-executed}
...
### Alat yang dieksekusi di server \{#server-executed-tools}
...
## Loop agentik (alat klien) \{#the-agentic-loop-client-tools}
...
## Loop sisi server \{#the-server-side-loop}
...
## Kapan menggunakan alat (dan kapan tidak) \{#when-to-use-tools-and-when-not-to}
...
## Memilih di antara pendekatan \{#choosing-between-approaches}
